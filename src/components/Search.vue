<template>
    <div>
        ...
        <el-row :gutter="20">
            ...
            <!-- 按类型查询 1.类型选择多选框 -->
            <el-col :span="12">
                <div class="grid-content bg-purple div-height div-check" style="overflow:auto;line-height:10px">
        ...
        <el-row :gutter="20">
            ...
            <!-- 按路径查询 1.路径选择多选框 -->
            <el-col :span="12">
                <div class="grid-content bg-purple div-height div-check" style="overflow:auto;line-height:25px">
